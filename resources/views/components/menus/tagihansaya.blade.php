            ...
            <tr>
                ...
                <td>Rp. {{ $r->harga }}</td>
                    ...
                    @if ($r->status == "Belum dibayar")
                        ...
                        <td>
                            <form action="{{ route('bukti', $r->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <label class="foto" for="foto">Upload Bukti</label>
                                <button type="submit" class="btn btn-success"><i class="bi bi-check-circle" ></i><br>Kirim</button>
